...
export default function App() {
  ...
  const raisons = [
    ...
    },
    {
      ...
      desc: "7 ans d'expérience professionnelle en France chez AXA, Mazars et Valophis, sur des problématiques de reporting réelles.",
    },
    {
    ...
    <div style={{ background: COLORS.bg, minHeight: "100vh", ...fontBody }} className="w-full">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <span style={{ ...fontDisplay, color: COLORS.text }} className="font-semibold text-sm">
              Excel Power BI Academy <span style={{ color: COLORS.muted, fontWeight: 400 }}>· Formation</span>
            </span>
          </div>
      ...
      <section className="max-w-3xl mx-auto px-6 pt-16 md:pt-24 pb-16">
        <div>
          ...
          <p style={{ ...fontMono, color: COLORS.mutedDark }} className="text-xs mb-1">
            Tarif à 199 € valable jusqu'au 30 juillet 2026
          </p>
          <p style={{ ...fontMono, color: COLORS.cyan }} className="text-xs mb-8">
            Paiement en 3 fois sans frais possible — 3 x 66,33 €
          </p>
        ...
        >
          <div className="flex md:flex-col items-center md:items-start gap-4">
            ...
            <div className="md:mt-2">
              ...
              <div style={{ color: COLORS.muted }} className="text-sm mb-2">Responsable Administratif &amp; Financier</div>
              <a
          ...
          <div className="md:col-span-2">
            ...
            <p style={{ color: COLORS.text }} className="leading-relaxed mb-4 text-sm">
              Responsable Administratif &amp; Financier avec 7 ans d'expérience en contrôle de gestion,
              comptabilité et pilotage de la performance (assurance, conseil). Actuellement RAF, je pilote la
              comptabilité technique et les KPI stratégiques. Passé par AXA et Mazars, je conçois aujourd'hui
              des tableaux de bord décisionnels sous Excel BI / Power BI pour accompagner la prise de
              décision.
            </p>
            <div className="flex flex-wrap gap-2">
              {["AXA", "Mazars", "Excel BI", "Power Query", "DAX"].map((t, i) => (
                <span
                  key={i}
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <p style={{ color: COLORS.muted }} className="text-sm mb-1">Paiement unique ou en 3 fois sans frais</p>
            <p style={{ ...fontMono, color: COLORS.cyan }} className="text-xs mb-1">Soit 3 x 66,33 € sans frais</p>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderTop: `1px solid ${COLORS.border}` }}>
        <span style={{ color: COLORS.mutedDark }} className="text-sm">© 2026 Excel Power BI Academy — Formation Excel &amp; Power BI</span>
